...
public class MapperUtil {
  ...
  public static <E> NotifyableMatrixCursor loadCollectionIntoCursor(final Iterable<E> collection, final String[] projection,
  ...
  private static <V> void appendReader(final HashMap<String, FieldReader<V>> ret, final String fieldName, final RawFieldReader<V> rawFieldReader,
