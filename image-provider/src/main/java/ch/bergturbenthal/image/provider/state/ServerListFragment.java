...
/**
 * A list fragment representing a list of Servers. This fragment also supports
...
public class ServerListFragment extends ListFragment {
  ...
  public void onCreate(final Bundle savedInstanceState) {
    ...
    adapter =
              new SimpleCursorAdapter(getActivity(), R.layout.simple_list_item_activated_1, null, new String[] { Client.ServerEntry.SERVER_NAME },
