...
public class CreateAlbumActivity extends Activity {
  ...
  public void createAlbum(final View view) {
    ...
    if (parentFolder == null) {
      final AlertDialog dialog = new AlertDialog.Builder(this).setMessage(R.string.create_folder_error_no_folder).setCancelable(false).create();
      dialog.show();
      return;
    }
    ...
    if (albumName == null || albumName.length() == 0) {
      final AlertDialog dialog =
                                 new AlertDialog.Builder(this).setMessage(R.string.create_folder_error_no_abum_name).setCancelable(false)
