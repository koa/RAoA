...
public class PhotoOverviewViewBinder implements ViewBinder {
	...
	public boolean setViewValue(View view, Cursor cursor, int columnIndex) {
		...
		final String thumbnailUriString = cursor.getString(cursor.getColumnIndex(Client.AlbumEntry.THUMBNAIL));
